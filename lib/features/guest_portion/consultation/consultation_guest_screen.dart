...
class ConsultationGuestScreen extends StatefulWidget {
  const ConsultationGuestScreen({super.key});

  @override
  State<ConsultationGuestScreen> createState() => _ConsultationGuestScreenState();
}

class _ConsultationGuestScreenState extends State<ConsultationGuestScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<HomeGuestProvider>().getConsultationList("page", "1");
    });
  }
  ...
  void _changePage(int newPage) {
    ...
    context.read<HomeGuestProvider>().getFacultyFilter("page", newPage.toString());
  }
  ...
  Widget build(BuildContext context) {
    ...
    final facultyList = controller.consultationMemberList.results ?? [];

    // Dynamically query total page variables from response payload; defaults to 1
    final int totalPages = controller.consultationMemberList.totalPages ?? 1;
          ...
          children: [
                  ...
                  Container(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: "Search by name, expertise, or scholar type...",
                        hintStyle: TextStyle(
                        ...
                        suffixIcon: _searchController.text.isNotEmpty
                            ? GestureDetector(
                                ...
                                child: Icon(Icons.clear, color: Colors.white.withOpacity(0.7), size: 18.r),
                              )
                            : null,
            ...
            controller.isDoorsLoading
                ? Padding(
                    ...
                    child: const Center(child: CircularProgressIndicator(color: headerColor)),
                  )
                : facultyList.isEmpty
                    ? Padding(
                        ...
                        child: const Center(
                          child: Text(
                            ...
                            style: TextStyle(color: descTextColor, fontStyle: FontStyle.italic),
                          ),
                        ),
                      )
                    : SizedBox(
                        height: 385.h, // Explicit height container matches FacultyCard boundaries safely
                          ...
                          itemBuilder: (context, index) {
                            return Padding(
                              ...
                              child: FacultyCard(
                                ...
                                onViewProfile: () {
                                  controller.getConsultationDetails(facultyList[index].id!.toInt());
                                  context.push(AppRoutes.consultationDetails, extra: facultyList[index].id);
                                },
                              ),
                            );
                          },
                      ...
                      ...List.generate(totalPages, (index) {
                        ...
                        return GestureDetector(
                          ...
                          child: AnimatedContainer(
                            ...
                            width: 38.r,
                            decoration: BoxDecoration(
                              color: isActive ? headerColor : const Color(0xFFF1F5F9),
